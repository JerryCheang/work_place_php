...
var pop_up_note_mode = true;
        ...
        function switchsound() {
            ...
            if (au.paused) {
                au.play();
                ai.src = "http://1.s.bama555.com/1/201411/20/b4071455ad5663d07b1ee73bdb18c333.png";
        ...
        function popup_note() {
            ...
            note.style.cssText = "visibility:visible;position:absolute;background-image:url('http://1.s.bama555.com/1/201411/20/3a5f6cb4d8cd4d5a82e34bbfa55cf3b3.png');width:15px;height:25px";
        ...
        function playbksound() {
            ...
            if (document.body.offsetWidth > 400) {
                bg_htm = "<img id='sound_image' src='http://1.s.bama555.com/1/201411/20/b4071455ad5663d07b1ee73bdb18c333.png'>";
                box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
            }
            else {
                bg_htm = "<img id='sound_image' width='30px' src='http://1.s.bama555.com/1/201411/20/b4071455ad5663d07b1ee73bdb18c333.png'>";
