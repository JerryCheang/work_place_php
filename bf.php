...
$delsql = "DROP table "."MK_".date("Ymd");
...
function inputdata($item) {
  ...
  $conn = mysql_connect($servername, $username, $password, $dbname);
  mysql_select_db($dbname, $conn);
  $sql1 = "insert into "."MK_".date("Ymd")."(sellerid,img,ititle,itemid) values('".$sellerid[1]."','".$img[1]."','".$ititle[1]."','".$itemid[1]."')";
